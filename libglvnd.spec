...
Source0  : https://gitlab.freedesktop.org/glvnd/libglvnd/-/archive/v1.7.0/libglvnd-v1.7.0.tar.gz
...
%prep
%setup -q -n libglvnd-v1.7.0
cd %{_builddir}/libglvnd-v1.7.0
pushd ..
cp -a libglvnd-v1.7.0 buildavx2
popd
pushd ..
cp -a libglvnd-v1.7.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720051172
